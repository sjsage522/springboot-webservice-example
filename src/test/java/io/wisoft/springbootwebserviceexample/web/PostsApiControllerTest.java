...
class PostsApiControllerTest {
    ...
    @Test
    @DisplayName("[성공 테스트] Posts 등록")
    public void posts_save_succeed_test() throws Exception {
        //given
        String title = "title";
    ...
    @Test
    @DisplayName("[성공 테스트] Posts 수정")
    public void posts_update_succeed_test() throws Exception {
        //given
